...
export default function App() {
    ...
    const [text, setText] = useState('');
     ...
     useEffect(() => {
        socket.current = connectWS();  // current is used for useRef
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-900 p-4 font-inter">
            ...
            {showNamePopup && (
                <div className="fixed inset-0 flex items-center justify-center z-40">
                    <div className="bg-gray-200 rounded-xl shadow-lg max-w-md p-6">
                        <h1 className="text-2xl font-Extrabold text-black">Enter your name</h1>
                    ...
                    <div className="px-4 py-3 border-t border-gray-200 bg-white">
                        <div className="flex items-center justify-between gap-4 border border-gray-200 rounded-full">
                            <textarea
                                ...
                                className="w-full resize-none px-4 py-4 text-sm outline-none rounded-lg "
                            />
                            <button
                                onClick={sendMessage}
